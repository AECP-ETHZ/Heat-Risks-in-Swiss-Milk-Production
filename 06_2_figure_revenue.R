...
#
# Part 6.2 /9: Figure for milk revenues (figure 2)
...
load("Models/final_knots_rev.RData")
load("Models/final_model_rev.RData")
...
ggsave(plot=plot_rev_centered,"Results(plot)/rev_main.pdf", width = 16, height = 12, unit="cm", device = cairo_pdf)
ggsave(plot=plot_rev_centered,"Results(plot)/rev_main.png", width = 16, height = 9, unit="cm")
