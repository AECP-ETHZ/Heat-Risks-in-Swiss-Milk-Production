...
#
# Robustness check 5: figure for milk revenues
#
# ==================================================================================================================================
# ==================================================================================================================================
...
load("APPENDIX/ShareRev/final_knots_rev_highrev.RData")
load("APPENDIX/ShareRev/final_model_rev_highrev.RData")
...
load("APPENDIX/ShareRev/final_knots_rev_lowrev.RData")
load("APPENDIX/ShareRev/final_model_rev_lowrev.RData")
