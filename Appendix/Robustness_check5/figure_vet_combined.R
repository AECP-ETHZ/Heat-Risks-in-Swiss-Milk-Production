...
#
# Robustness check 5: figure for veterinary expenses
#
# ==================================================================================================================================
# ==================================================================================================================================
...
load("APPENDIX/ShareRev/final_knots_vet_highrev.RData")
load("APPENDIX/ShareRev/final_model_vet_highrev.RData")
...
load("APPENDIX/ShareRev/final_knots_vet_lowrev.RData")
load("APPENDIX/ShareRev/final_model_vet_lowrev.RData")
...
for (s in 1:length(plot_titles)){
  ...
  list_centered_plots[[s]] <- ggplot()+ggtitle(paste(plot_titles[s],sep=""))+
    ...
    annotate("text", x = 57, y = 0.0060, label = paste("high milk revenues subsample (",number_farms_up," farms)",sep=""), colour = "brown1",family="Times New Roman",size=2)+
    annotate("text", x = 56, y = 0.0050, label = paste("low milk revenues subsample (",number_farms_down," farms)",sep=""), colour = "cornflowerblue",family="Times New Roman",size=2)+
...
ggsave(plot=plot_vet_centered,"APPENDIX/ShareRev/vet_samples.pdf", width = 16, height = 16, unit="cm", device = cairo_pdf)
ggsave(plot=plot_vet_centered,"APPENDIX/ShareRev/vet_samples.png", width = 16, height = 9, unit="cm")
