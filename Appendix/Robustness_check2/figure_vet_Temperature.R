...
#
# Robustness check 2: figures for temperature effects on veterinary expenses
#
# ==================================================================================================================================
# ==================================================================================================================================
...
load("APPENDIX/TempOnly/final_knots_vet.RData")
load("APPENDIX/TempOnly/final_model_vet.RData")
...
for (s in 1:length(plot_titles)){
  ...
  list_absolut_plots[[s]] <- ggplot()+ggtitle(paste(plot_titles[s],"\n", "(",number_farms," farms",")",sep=""))+
    ...
    xlab("Temperature [°C]") + ylab("log(vet expenses) [CHF]")+
  ...
  list_centered_plots[[s]] <- ggplot()+ggtitle(paste(plot_titles[s],"\n", "(",number_farms," farms",")",sep=""))+
    ...
    xlab("Temperature [°C]") + ylab("log(veterinary expenses) [CHF]")+
...
ggsave(plot=plot_vet_centered,"APPENDIX/TempOnly/vet_main.png", width = 16, height = 9, unit="cm")
