...
#
# Robustness check 2: model for temperature effects on veterinary expenses
#
# ==================================================================================================================================
# ==================================================================================================================================
...
for (z in 1:length(names(sub_panels_ID))){
  ...
  temp_list_models[[1]] <- feols(log(sk_Tierarzt) ~ Temperature + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  ...
  for (k in 1:length(knot_range)){
    ...
    temp1 <-  feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  ...
  temp_list_models[[2]] <- feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  rm(temp_new_ts_T_ls, sub_farm_T_hourly_extended, sub_farm_panel_T_PP_yearly,temp1)
  ...
  for (k in 1:ncol(knots_2_combi_good)){
    ...
    temp1 <- feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + s_Temperature_3 + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  ...
  temp_list_models[[3]] <- feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + s_Temperature_3 + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  ...
  for (k in 1:ncol(knots_3_combi_good)){
    ...
    temp1 <- feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + s_Temperature_3 +s_Temperature_4 + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  ...
  temp_list_models[[4]] <- feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + s_Temperature_3 +s_Temperature_4 + precip +pp2 |  farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
  rm(temp_new_ts_T_ls, sub_farm_T_hourly_extended, sub_farm_panel_T_PP_yearly)
  ...
  if( best_model_number == 1){
    ...
    list_final_model[[z]] <- feols(log(sk_Tierarzt) ~ Temperature + precip +pp2 | farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
    rm(sub_farm_panel_T_PP_yearly)
    ...
    list_final_model[[z]] <-  feols(log(sk_Tierarzt) ~ s_Temperature_1 + s_Temperature_2 + precip +pp2 | farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
    rm(temp_new_ts_T_ls, sub_farm_T_hourly_extended, sub_farm_panel_T_PP_yearly) 
    ...
    list_final_model[[z]] <-  feols(log(sk_Tierarzt) ~ s_Temperature_1 +s_Temperature_2+s_Temperature_3 + precip +pp2 | farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
    rm(temp_new_ts_T_ls, sub_farm_T_hourly_extended, sub_farm_panel_T_PP_yearly) 
    ...
    list_final_model[[z]] <-  feols(log(sk_Tierarzt) ~ s_Temperature_1 +s_Temperature_2+s_Temperature_3 + s_Temperature_4 + precip +pp2 | farm + year, data = sub_farm_panel_T_PP_yearly, cluster=c("farm", "year"))
    rm(temp_new_ts_T_ls, sub_farm_T_hourly_extended, sub_farm_panel_T_PP_yearly) 
  }
...
save(list_final_model_vet, file="APPENDIX/TempOnly/final_model_vet.RData")
save(list_final_knot_combination_vet, file="APPENDIX/TempOnly/final_knots_vet.RData")