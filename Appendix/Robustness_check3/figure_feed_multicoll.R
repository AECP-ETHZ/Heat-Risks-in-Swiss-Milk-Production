...
#
# Robustness check 3: figure without precipitation for feed purchases
#
# ==================================================================================================================================
# ==================================================================================================================================
...
load("APPENDIX/Multicollinearity/final_knots_feed.RData")
load("APPENDIX/Multicollinearity/final_model_feed.RData")
...
ggsave(plot=plot_feed_centered,"APPENDIX/Multicollinearity/feed_main.pdf", width = 16, height = 16, unit="cm", device = cairo_pdf)
ggsave(plot=plot_feed_centered,"APPENDIX/Multicollinearity/feed_main.png", width = 16, height = 9, unit="cm")
