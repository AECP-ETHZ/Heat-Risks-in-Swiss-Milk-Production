...
#
# Robustness check 3: figure without precipitation for milk revenues
#
# ==================================================================================================================================
# ==================================================================================================================================
...
load("APPENDIX/Multicollinearity/final_knots_rev.RData")
load("APPENDIX/Multicollinearity/final_model_rev.RData")
...
for (s in 1:length(plot_titles)){
  ...
  # Data preparation
  temp_model <- list_final_model_rev[[s]]
  temp_knot  <- list_final_knot_combination_rev[[s]]
  
  sub_dairy_farms_panel_final <- dairy_farms_panel_final[which(dairy_farms_panel_final$farm %in% sub_panels_ID[[s]]),]
...
ggsave(plot=plot_rev_centered,"APPENDIX/Multicollinearity/rev_main.pdf", width = 16, height = 12, unit="cm", device = cairo_pdf)
ggsave(plot=plot_rev_centered,"APPENDIX/Multicollinearity/rev_main.png", width = 16, height = 9, unit="cm")
