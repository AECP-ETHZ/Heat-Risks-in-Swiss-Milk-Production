...
#
# Robustness check 3: figure without precipitation for veterinary expenses
#
# ==================================================================================================================================
# ==================================================================================================================================
...
load("APPENDIX/Multicollinearity/final_knots_vet.RData")
load("APPENDIX/Multicollinearity/final_model_vet.RData")
...
ggsave(plot=plot_vet_centered,"APPENDIX/Multicollinearity/vet_main.pdf", width = 16, height = 16, unit="cm", device = cairo_pdf)
ggsave(plot=plot_vet_centered,"APPENDIX/Multicollinearity/vet_main.png", width = 16, height = 9, unit="cm")
