...
#
# Robustness check 3: model without precipitation for veterinary expenses
#
# ==================================================================================================================================
# ==================================================================================================================================
...
for (z in 1:length(names(sub_panels_ID))){
  ...
  temp_list_models[[1]] <- feols(log(sk_Tierarzt) ~ THI  | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  ...
  for (k in 1:length(knot_range)){
    ...
    temp1 <- feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2 | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  ...
  temp_list_models[[2]] <- feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2 | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  rm(temp_new_ts_THI_ls, sub_farm_THI_hourly_extended, sub_farm_panel_THI_PP_yearly,temp1)
  ...
  for (k in 1:ncol(knots_2_combi_good)){
    ...
    temp1 <- feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2+ s_THI_3  | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  ...
  temp_list_models[[3]] <- feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2+ s_THI_3 | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  ...
  for (k in 1:ncol(knots_3_combi_good)){
    ...
    temp1 <- feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2+ s_THI_3 +s_THI_4 | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  ...
  temp_list_models[[4]] <- feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2+ s_THI_3 +s_THI_4 | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
  rm(temp_new_ts_THI_ls, sub_farm_THI_hourly_extended, sub_farm_panel_THI_PP_yearly)
  ...
  if( best_model_number == 1){
    ...
    list_final_model[[z]] <- feols(log(sk_Tierarzt) ~ THI  | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
    rm(sub_farm_panel_THI_PP_yearly)
    ...
    list_final_model[[z]] <-  feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2  | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
    rm(temp_new_ts_THI_ls, sub_farm_THI_hourly_extended, sub_farm_panel_THI_PP_yearly) 
    ...
    list_final_model[[z]] <-  feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2+ s_THI_3 | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
    rm(temp_new_ts_THI_ls, sub_farm_THI_hourly_extended, sub_farm_panel_THI_PP_yearly) 
    ...
    list_final_model[[z]] <-  feols(log(sk_Tierarzt) ~ s_THI_1 + s_THI_2+ s_THI_3 + s_THI_4  | farm + year, data =sub_farm_panel_THI_PP_yearly,  cluster = c("farm","year"))
    rm(temp_new_ts_THI_ls, sub_farm_THI_hourly_extended, sub_farm_panel_THI_PP_yearly) 
  }
...
save(list_final_model_vet, file="APPENDIX/Multicollinearity/final_model_vet.RData")
save(list_final_knot_combination_vet, file="APPENDIX/Multicollinearity/final_knots_vet.RData")
