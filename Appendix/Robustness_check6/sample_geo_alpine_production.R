...
#
# Robustness check 6: sample selection for farms without temporal Aline milk production
# Note: Then run the other scripts for the main results
#
# ==================================================================================================================================
# ==================================================================================================================================
...
dairy_farms_panel_final <- dairy_farms_panel_final[,c("lD","Gemeinde", "Jahr","Region","LN","landGruenland_tot","kgMilch_jeKuh","Stk_Milchkuehe","rohMilch","sk_KraftfuRind","sk_uebrigesFutter","sk_Tierarzt","sk_TiereVersch", "sk_Futter_tot", "vet_insem_tot","rohSoemmbeitr","sk_Soemmerung")]
colnames(dairy_farms_panel_final)[1] <- "farm"
colnames(dairy_farms_panel_final)[3] <- "year"
length(unique(dairy_farms_panel_final$farm))

# v) Subsetting for farms without temporary milk production in the Alps (Soemmerung)

dairy_farms_panel_final <- dairy_farms_panel_final[which(dairy_farms_panel_final$rohSoemmbeitr == 0 & dairy_farms_panel_final$sk_Soemmerung == 0),]
