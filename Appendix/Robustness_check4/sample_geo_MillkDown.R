...
#
# Robustness check 4: sample selection for farms with cows with low milk productivity
#
# ==================================================================================================================================
# ==================================================================================================================================
...
'Subset for veterinary expenses or feed purchases (adjust!)'
...
average_milk_production <- as.data.frame(matrix(NA, nrow=length(good_farms_panel), ncol=2))
average_milk_production[,1] <- good_farms_panel

for (i in 1:nrow(average_milk_production)){
  temp1 <- dairy_farms_panel_final[which(dairy_farms_panel_final$farm == average_milk_production[i,1]),]
  average_milk_production[i,2] <- mean(temp1$kgMilch_jeKuh, na.rm=T) 
}

rm(good_farms_panel)
good_farms_panel <- average_milk_production[which(average_milk_production[,2] < quantile(average_milk_production[,2], 0.5, type=4)),1]
...
average_milk_production <- as.data.frame(matrix(NA, nrow=length(good_farms_panel_plain), ncol=2))
average_milk_production[,1] <- good_farms_panel_plain
...
good_farms_panel_plain <- average_milk_production[which(average_milk_production[,2] < quantile(average_milk_production[,2], 0.5, type=4)),1]
...
average_milk_production <- as.data.frame(matrix(NA, nrow=length(good_farms_panel_hill), ncol=2))
average_milk_production[,1] <- good_farms_panel_hill
...
good_farms_panel_hill <- average_milk_production[which(average_milk_production[,2] < quantile(average_milk_production[,2], 0.5, type=4)),1]
...
average_milk_production <- as.data.frame(matrix(NA, nrow=length(good_farms_panel_mountain), ncol=2))
average_milk_production[,1] <- good_farms_panel_mountain
...
good_farms_panel_mountain <- average_milk_production[which(average_milk_production[,2] < quantile(average_milk_production[,2], 0.5, type=4)),1]
